...
export const PURPOSE_CATALOG: readonly CatalogEntry[] = [
  ...
  },
  {
    ...
    title: PURPOSES["childcare-service-subsidy"].title,
    summary: "幼兒離開 0–2 歲帶後接手的那一筆。設籍與親子關係即可發票，述詞比育兒津貼還少一項。",
    agencyName: PURPOSES["childcare-service-subsidy"].agencyName,
    agencyId: PURPOSES["childcare-service-subsidy"].agency,
    purposeId: "childcare-service-subsidy",
    issuable: true,
    topics: ["childcare"],
    keywords: ["托育", "育兒", "幼兒", "社會局", "未滿 5 歲"],
    requiredPredicates: [...PURPOSES["childcare-service-subsidy"].allowedClaims],
    missing: [],
  },
  {
    id: "aircon-subsidy",
